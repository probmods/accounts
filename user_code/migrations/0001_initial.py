...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'user_code_exercise', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'user_code', ['Exercise'])

        # Adding model 'User_code'
        db.create_table(u'user_code_user_code', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'user_code', ['User_code'])


    def backwards(self, orm):
        # Deleting model 'Exercise'
        db.delete_table(u'user_code_exercise')

        # Deleting model 'User_code'
        db.delete_table(u'user_code_user_code')
